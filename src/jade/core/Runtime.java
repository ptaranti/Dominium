...
public class Runtime {
	...
	public static String getVersion() {
		String version = "3.5"; // The $ surrounded Version keyword is automatically replaced by the target doTag of build.xml
		return version;
	}
	
	public static String getRevision() {
		String revision = "5988"; // The $ surrounded WCREV keyword is automatically replaced by WCREV with subversion
		return revision;
	}
	
	public static String getDate() {
		String date = "2007/06/21 11:02:30"; // The $ surrounded WCDATE keyword is automatically replaced by WCREV with subversion
		return date;
	}
}
