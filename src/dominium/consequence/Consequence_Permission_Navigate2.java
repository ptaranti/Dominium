...
public class Consequence_Permission_Navigate2 extends OneShotBehaviour {

	ConsequenceAgent consequenceAgent;
	AID aid = new AID();
	

	public Consequence_Permission_Navigate2 (ConsequenceAgent consequenceAgent, AID aid){
