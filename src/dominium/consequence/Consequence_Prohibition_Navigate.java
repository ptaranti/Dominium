...
public class Consequence_Prohibition_Navigate extends OneShotBehaviour {

	ConsequenceAgent consequenceAgent;
	AID aid = new AID();
	

	public Consequence_Prohibition_Navigate (ConsequenceAgent consequenceAgent, AID aid){
